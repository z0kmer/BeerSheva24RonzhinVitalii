...
router.post('/add', auth, authorize('USER', 'PREMIUM_USER'), favoritesController.addFavorite);
...
router.put('/update', auth, authorize('USER', 'PREMIUM_USER', 'ADMIN'), favoritesController.updateFavorite);

// Удаление фильма из избранного (доступно для всех, кроме ADMIN)
router.delete('/:favoriteId', auth, authorize('USER', 'PREMIUM_USER'), favoritesController.deleteFavorite);
